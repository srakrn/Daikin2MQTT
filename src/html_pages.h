...
"<div id='l1' name='l1'>"
    "<fieldset>"
        ...
        "<p><b>_TXT_CTRL_WVANE_</b>"
            ...
            "</form>"
        "</p>"
        "<p><b>_TXT_CTRL_POWERFUL_</b>"
            "<form onchange='this.submit()' method='POST'>"
                "<select name='POWERFUL' id='POWERFUL'>"
                    "<option value='OFF' _POWERFUL_OFF_> _TXT_F_OFF_</option>"
                    "<option value='ON' _POWERFUL_ON_>&#128170; _TXT_F_ON_</option>"
                "</select>"
            "</form>"
        "</p>"
        "<p><b>_TXT_CTRL_ECO_</b>"
            "<form onchange='this.submit()' method='POST'>"
                "<select name='ECO' id='ECO'>"
                    "<option value='OFF' _ECO_OFF_> _TXT_F_OFF_</option>"
                    "<option value='ON' _ECO_ON_>&#127811; _TXT_F_ON_</option>"
                "</select>"
            "</form>"
        "</p>"
        "<p><b>_TXT_CTRL_QUIET_</b>"
            "<form onchange='this.submit()' method='POST'>"
                "<select name='QUIET' id='QUIET'>"
                    "<option value='OFF' _QUIET_OFF_> _TXT_F_OFF_</option>"
                    "<option value='ON' _QUIET_ON_>&#128263; _TXT_F_ON_</option>"
                "</select>"
            "</form>"
        "</p>"
    "</fieldset>"
...
"if (_X50_PROTOCOL_) {"
    ...
    "document.getElementById('POWERFUL').disabled = true;"
    "document.getElementById('ECO').disabled = true;"
    "document.getElementById('QUIET').disabled = true;"
"}"
"</script>"
;
